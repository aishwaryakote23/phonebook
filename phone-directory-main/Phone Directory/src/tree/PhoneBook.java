...
public class PhoneBook extends JFrame {
	...
	public PhoneBook() {
		...
		setTitle("PhoneBook");
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage("E:\\Phone Directory\\src\\Img\\Add.png"));
		...
		lblSukkurIbaUniversity.setFont(new Font("Times New Roman", Font.BOLD, 26));
		lblSukkurIbaUniversity.setForeground(new Color(0, 0, 0));
		lblSukkurIbaUniversity.setBounds(48, 158, 686, 40);
		panel.add(lblSukkurIbaUniversity);
		
		JLabel lblNewLabel = new JLabel();
		lblNewLabel.setBackground(Color.GRAY);
		lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/SIBAU.png")));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(10, 11, 724, 154);
		panel.add(lblNewLabel);
		
		JButton Search = new JButton("");
		Search.setBorder(null);
		Search.setBackground(null);
		Search.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Search.png")));
		...
		Add.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Add.png")));
		...
		Remove.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/remove.png")));
		...
		Display.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/list.png")));
